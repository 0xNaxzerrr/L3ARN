...
import { ArrowRight, Shield, Folder, Clock } from "lucide-react";
    ...
    <div className="flex-1 bg-gray-900 min-h-screen">
      ...
      <section className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white transition-all duration-300">
