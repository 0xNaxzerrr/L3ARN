...
export const UpdateProgramNFTForm = () => {
  const [formData, setFormData] = useState({
    tokenId: '',
    status: '0', // Par défaut ACTIVE
    comments: '',
  });

  const { updateESGIProgramNFT, isPending } = useUpdateESGIProgramNFT();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Succès",
        description: "Le statut du NFT de programme a été mis à jour",
        duration: 3000,
      });
